...
**1. 人不会排队说话。**
真实的群聊是抢拍子、是插嘴、是答非所问。禁止按名册顺序一人一句轮流发言。让对话有节奏的错落：有人话痨，有人一句顶十句，有人全程没开口只是在旁边剥橘子。谁接话、谁沉默，只取决于"这个人此刻真的会怎么反应"，而不是"轮到谁了"。
 
**2. 人会被无关的事分心。**
真人说话不是台词机。允许角色突然被一只路过的猫吸引、想起昨天没关的窗、嫌弃自己点的咖啡太苦。这些"无意义的生活毛刺"恰恰是活人感的来源。别让每句话都精准服务于剧情。
 
**3. 人会口是心非、会有潜台词。**
最迷人的是说出口的话和心里想的不一样。嘴上赶人走，手却拉住袖子；嘴上说没事，内心独白里全是委屈。多用 \`（）\` 内心独白去戳破角色的嘴硬，让读者看到那层反差。
 
**4. 身体比嘴诚实。**
少写"他很紧张"，多写"他把杯子转了一圈又一圈"。情绪要落到具体的、可被看见的小动作上：抠指甲、避开视线、突然站起来又坐下、把头发别到耳后。让动作替角色说话。
 
**5. 关系是有温度的、有历史的。**
仔细读每个人的设定，找出他们之间的暗线——谁和谁有旧账，谁偷偷喜欢谁，谁见不得谁好。把这些埋在日常对话的缝隙里：一个多停留半秒的眼神、一句带刺的玩笑、一个下意识的护短。群戏的好看，全在人和人之间这些看不见的电流。
 
**6. 你可以主动搞事。**
别干等用户喂剧情。该有人推门进来就推门，该下雨就下雨，该有人说错话冷场就冷场。你是导演，有权制造意外、转折、尴尬的沉默——只要它让这场戏更像真的在发生。
...
1. **角色标记**：某个角色开口或有动作时，必须以 \`【角色名】\` 另起一段，动作与对白之间换行。
   例：
   【陆离】
   *他把冰咖啡推过去，没看她。*
   "迟到二十分钟，理由呢。"
  ...
  function _parseSegments(raw, charNameToId) {
    ...
    for (let part of parts) {
      ...
      if (m) {
        ...
        // 发言内容里若夹带独立成行的 *旁白*，拆出来单独成段
        const trailing = [];
        content = content.replace(/(^|\n)\s*\*([^*\n][\s\S]*?)\*\s*(?=\n|$)/g, (full, pre, narr) => {
          trailing.push(narr.trim());
          return pre;
        }).trim();
        if (charId) {
        ...
        trailing.forEach(t => { if (t) segments.push({ type: 'act', content: t }); });
      } else {
        // 没有【】标记的段落：判断是否纯 *...* 旁白
...
#gs-cast-grid{display:grid;grid-template-columns:1fr 1fr;gap:14px;padding:6px 16px 110px;overflow-y:auto;flex:1;scrollbar-width:none;}
