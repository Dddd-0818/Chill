...
const DiaryModule = (() => {
    ...
    function _injectStyles() {
        ...
        style.textContent = `
            ...
            /* 墨迹解密 */
            #diary-view-detail .redact-block { color: transparent; text-shadow: 0 0 7px rgba(34, 34, 34, 0.35); cursor: pointer; position: relative; display: inline-block; transition: all 0.8s cubic-bezier(0.16, 1, 0.3, 1); user-select: none; border-bottom: 0.5px dotted rgba(34, 34, 34, 0.25); padding: 0 2px; }
